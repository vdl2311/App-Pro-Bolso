...
import { LayoutGrid, Wallet, BarChart2, ShieldAlert, RotateCcw } from 'lucide-react';
...
export default function App() {
  ...
  const handleReset = () => {
    if (window.confirm("Deseja realmente limpar todos os ganhos e gastos registrados?")) {
